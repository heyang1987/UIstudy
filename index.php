...
//        $_SESSION["lastname"] = "He";  
    ...
    <div class="parent_container">
        ...
        <div id="consentBody">
            ...
            This is a study about the use of various smart home devices/gadgets, such as TVs and refrigerators that are connected to the Internet and contain software and sensors that make them "smart". The survey is about managing the basic data generated by these devices.</p>
            <p>Your part in the study will be to complete a questionnaire. You will be presented with a smart home settings user interface, and asked to answer a few simple questions about that user interface.</p>
            ...
            <p>We do not know of any way you would benefit directly from taking part in this study. However, this research may help us to understand how we can improve the smart home experience.</p>
        ...
        <div id="preIntro">
            <div>
                ...
                <hr>
                <p>On the next page, you will be given some explanation about the smart home. The contents will be shown in the form of figures and <strong>audio</strong>. This information is important for evaluating the UI in this study. Please adjust your <strong>volume</strong> and pay close attention to the content. Thank you!</p>
                <img src="images/smarthome.jpg" width="800px">
            </div>
            <div class="bottomrow">
