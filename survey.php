...
<!--    complexity & match-->
    <div id="surveypage4">
        <div>
            ...
            <span><div>
            <br/><label for='mtch1'><input type='radio' id='mtch1' name='mtch' value='-2' onclick='boldage(this)'/>  Strongly Disagree </label>  
            <br/><label for='mtch2'><input type='radio' id='mtch2' name='mtch' value='-1' onclick='boldage(this)'/>  Disagree </label>  
            <br/><label for='mtch3'><input type='radio' id='mtch3' name='mtch' value='0' onclick='boldage(this)'/>  Neutral </label>  
            <br/><label for='mtch4'><input type='radio' id='mtch4' name='mtch' value='1' onclick='boldage(this)'/>  Agree </label>  
            <br/><label for='mtch5'><input type='radio' id='mtch5' name='mtch' value='2' onclick='boldage(this)'/>  Strongly Agree </label>  
            </div></span>
...
<!--    6 collect-->
    ...
    <div id="surveypage14">
        ...
        <button type="button" id="surveypage14button" class="button right"><strong>Next</strong></button>
    </div>

 
    <div id="end">
        <h2>Thank You!</h2>
            <p>You have finished all the survey questions! Your personal code is <Strong><?php echo $id?></Strong>. Please enter it on the next page.</p><br>
        <button type="button" id="endPrev" class="button">Back</button>
